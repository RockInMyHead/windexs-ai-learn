...
const CTA = () => {
  return (
    <section className="py-16 md:py-32 px-4 pb-20 md:pb-32 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="relative bg-card/90 backdrop-blur-xl rounded-3xl border-2 border-primary/30 p-6 md:p-12 lg:p-20 text-center shadow-2xl shadow-primary/30 animate-scale-in overflow-hidden">
          {/* Background pattern */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-base md:text-xl lg:text-2xl text-muted-foreground mb-6 md:mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex justify-center mb-8">
              <Button
                size="lg"
                className="group relative overflow-hidden bg-gradient-to-r from-primary to-accent hover:shadow-2xl hover:shadow-primary/60 transition-all duration-300 text-white border-0 px-6 md:px-12 py-4 md:py-7 text-base md:text-lg font-semibold"
              >
